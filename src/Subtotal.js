...
function Subtotal() {
    ...
    const whatsappLink = "https://api.whatsapp.com/send?phone=918398070824&text=" + " items" + " = " + getBasketItems(basket) + " total rupees" + " = " + getBasketTotal(basket) + " name" + " = " +name + " table number = " +tableNo
